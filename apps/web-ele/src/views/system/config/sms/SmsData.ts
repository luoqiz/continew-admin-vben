...
export function useSmsGridSearchFormSchema(): VbenFormSchema[] {
  return [
    { fieldName: 'name', label: $t('system.sms.name') || '名称', component: 'Input' },
...
export function useSmsGridFieldColumns(): VxeTableGridOptions['columns'] {
  return [
    ...
    { field: 'name', title: $t('system.sms.name'), align: 'center', fixed: 'left' },
    { field: 'supplier', title: $t('system.sms.supplier'), align: 'center' },
    { field: 'isDefault', title: '是否默认', align: 'center', slots: { default: 'isDefault' } },
    ...
    { field: 'status', title: $t('common.status') || '状态', align: 'center', slots: { default: 'status' } },
